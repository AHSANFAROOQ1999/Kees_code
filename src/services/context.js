...
export function updateGlobalMinicart() {
  const MiniCart = ReactDOM.render(<MiniCart />, document.getElementById('root'));
  MiniCart.updateCart();
}
...
export function fetchVisitedProducts() {
  ...
  if (visited_products_handles) {
    ...
    return axios.post(process.env.REACT_APP_BACKEND_HOST + '/storefront/visited_products', body)
      .then((response) => {
    ...
    if (visitedProducts) {
      ...
      if (visitedProducts.indexOf(catName) < 0) {
        if (visitedProducts.length >= 11) {
          ...
          localStorage.setItem('visited_products', catName + ' , ' + localStorage.getItem('visited_products'))
        }
      }
    }
    else {
...
export const cityOptions = [
  ...
  { key: '43', value: 'Leqtaifiya (West Bay Lagoon)', text: 'Leqtaifiya (West Bay Lagoon)' },
  ...
  { key: '49', value: 'Fereej Mohammed Bin Jassim', text: 'Fereej Mohammed Bin Jassim' },
  ...
  { key: '63', value: 'Doha International Airport', text: 'Doha International Airport' },
  ...
  { key: '71', value: 'Al Thumama (Al Wakrah)', text: 'Al Thumama (Al Wakrah)' },
  { key: '72', value: 'Al Wukair', text: 'Al Wukair' },
  { key: '73', value: 'Mesaieed Industrial Area', text: 'Mesaieed Industrial Area' },
  ...
  { key: '106', value: 'New Fereej Al Khulaifat', text: 'New Fereej Al Khulaifat' },
